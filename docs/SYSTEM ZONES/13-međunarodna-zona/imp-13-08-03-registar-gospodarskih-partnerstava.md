# IMP-13-08-03 — Registar globalnih komunikacijskih i predstavničkih aktivnosti

**Status:** ODOBRENO  
**Zona:** 13 — Međunarodna zona  
**Modul:** 13.8 Globalna komunikacija i predstavljanje  
...
Ovim dokumentom utvrđuje se službeni okvir za područje **Registar globalnih komunikacijskih i predstavničkih aktivnosti** unutar modula
**13.8 Globalna komunikacija i predstavljanje** Međunarodne zone projekta IMPERIOR.
...
pripadaju modulu **13.8 Globalna komunikacija i predstavljanje**, uključujući pripremu, provedbu, praćenje, evaluaciju i
arhiviranje.
...
Ovaj dokument pripada isključivo modulu **13.8 Globalna komunikacija i predstavljanje**. Njegova službena oznaka ostaje
**IMP-13-08-03**. Prethodni sadržaj iste datoteke smatra se zamijenjenim ovom verzijom.
