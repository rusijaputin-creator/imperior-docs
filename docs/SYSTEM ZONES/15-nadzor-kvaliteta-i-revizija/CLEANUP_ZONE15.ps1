...
$base = Join-Path (Get-Location) "docs\SYSTEM ZONES\15-nadzor-kvaliteta-i-revizija"
...
Write-Host ""
Write-Host "Zone 15 cleanup complete. Review with: git status"
Write-Host "Suggested commit: Finalize Zone 15 documentation structure"