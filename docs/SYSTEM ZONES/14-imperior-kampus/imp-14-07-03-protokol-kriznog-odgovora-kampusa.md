# Upravljanje parkirališnim, transportnim i pristupnim kapacitetima

**Kod:** `IMP-14-07-03`  
**Zona:** 14 — IMPERIOR kampus  
**Modul:** 14.7 Promet, logistika i pristup  
**Status:** ODOBRENO  
**Vrsta dokumenta:** Sustavni dokument

## 1. Svrha

Definira upravljanje parkiranjem, transportnim kapacitetima, pristupnim režimima i prioritetima kretanja u kampusu.

## 2. Područje primjene

Dokument se primjenjuje na sve organizacijske jedinice, objekte, programe i odgovorne osobe koje djeluju unutar područja modula **14.7 Promet, logistika i pristup**.
