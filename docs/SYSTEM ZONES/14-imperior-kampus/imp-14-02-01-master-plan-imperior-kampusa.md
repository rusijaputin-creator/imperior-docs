# Okvir rezidencijalnog sustava IMPERIOR kampusa

**Kod:** `IMP-14-02-01`  
**Zona:** 14 — IMPERIOR kampus  
**Modul:** 14.2 Rezidencijalni sustav  
**Status:** ODOBRENO  
**Vrsta dokumenta:** Sustavni dokument

## 1. Svrha

Definira temeljni model stanovanja, rezidencijalne zone, tipove smještaja i pravila razvoja rezidencijalnog sustava kampusa.

## 2. Područje primjene

Dokument se primjenjuje na sve organizacijske jedinice, objekte, programe i odgovorne osobe koje djeluju unutar područja modula **14.2 Rezidencijalni sustav**.
