# Standard obrazovnih i istraživačkih centara kampusa

**Kod:** `IMP-14-04-02`  
**Zona:** 14 — IMPERIOR kampus  
**Modul:** 14.4 Obrazovni i istraživački sadržaji  
**Status:** ODOBRENO  
**Vrsta dokumenta:** Sustavni dokument

## 1. Svrha

Utvrđuje standarde rada obrazovnih i istraživačkih centara, uključujući kvalitetu, sigurnost, etiku i evaluaciju.

## 2. Područje primjene

Dokument se primjenjuje na sve organizacijske jedinice, objekte, programe i odgovorne osobe koje djeluju unutar područja modula **14.4 Obrazovni i istraživački sadržaji**.
