# Standard javnih, društvenih i uslužnih sadržaja

**Kod:** `IMP-14-05-02`  
**Zona:** 14 — IMPERIOR kampus  
**Modul:** 14.5 Javni i društveni sadržaji  
**Status:** ODOBRENO  
**Vrsta dokumenta:** Sustavni dokument

## 1. Svrha

Utvrđuje standarde dostupnosti, kvalitete, uključivosti i upravljanja javnim, društvenim i uslužnim sadržajima.

## 2. Područje primjene

Dokument se primjenjuje na sve organizacijske jedinice, objekte, programe i odgovorne osobe koje djeluju unutar područja modula **14.5 Javni i društveni sadržaji**.
