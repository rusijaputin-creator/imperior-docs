# Standard uređenja, održavanja i korištenja zelenih i rekreacijskih površina

**Kod:** `IMP-14-08-02`  
**Zona:** 14 — IMPERIOR kampus  
**Modul:** 14.8 Zelene površine i rekreacija  
**Status:** ODOBRENO  
**Vrsta dokumenta:** Sustavni dokument

## 1. Svrha

Utvrđuje standarde održavanja, pristupačnosti, sigurnosti, očuvanja prirode i korištenja sportskih i rekreacijskih prostora.

## 2. Područje primjene

Dokument se primjenjuje na sve organizacijske jedinice, objekte, programe i odgovorne osobe koje djeluju unutar područja modula **14.8 Zelene površine i rekreacija**.
