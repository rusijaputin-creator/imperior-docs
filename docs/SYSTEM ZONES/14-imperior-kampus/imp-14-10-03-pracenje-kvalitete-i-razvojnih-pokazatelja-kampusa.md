# Sustav praćenja kvalitete i dugoročnog razvoja kampusa

**Kod:** `IMP-14-10-03`  
**Zona:** 14 — IMPERIOR kampus  
**Modul:** 14.10 Održavanje, razvoj i kvaliteta kampusa  
**Status:** ODOBRENO  
**Vrsta dokumenta:** Sustavni dokument

## 1. Svrha

Uspostavlja pokazatelje, izvještavanje, evaluaciju, korektivne mjere i razvojne cikluse za kontinuirano poboljšanje kampusa.

## 2. Područje primjene

Dokument se primjenjuje na sve organizacijske jedinice, objekte, programe i odgovorne osobe koje djeluju unutar područja modula **14.10 Održavanje, razvoj i kvaliteta kampusa**.
