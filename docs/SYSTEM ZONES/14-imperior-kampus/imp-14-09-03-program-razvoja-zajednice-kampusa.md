# Plan razvoja digitalnih usluga i otpornosti sustava

**Kod:** `IMP-14-09-03`  
**Zona:** 14 — IMPERIOR kampus  
**Modul:** 14.9 Digitalna infrastruktura kampusa  
**Status:** ODOBRENO  
**Vrsta dokumenta:** Sustavni dokument

## 1. Svrha

Definira razvoj digitalnih usluga, rezervne kapacitete, kontinuitet rada, oporavak i dugoročnu tehnološku nadogradnju.

## 2. Područje primjene

Dokument se primjenjuje na sve organizacijske jedinice, objekte, programe i odgovorne osobe koje djeluju unutar područja modula **14.9 Digitalna infrastruktura kampusa**.
