# Protokol kriznog odgovora i kontinuiteta kampusa

**Kod:** `IMP-14-06-03`  
**Zona:** 14 — IMPERIOR kampus  
**Modul:** 14.6 Sigurnost kampusa  
**Status:** ODOBRENO  
**Vrsta dokumenta:** Sustavni dokument

## 1. Svrha

Definira postupke odgovora na krizne događaje, koordinaciju službi, zaštitu ljudi i nastavak ključnih funkcija kampusa.

## 2. Područje primjene

Dokument se primjenjuje na sve organizacijske jedinice, objekte, programe i odgovorne osobe koje djeluju unutar područja modula **14.6 Sigurnost kampusa**.
